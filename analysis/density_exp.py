...
for repetition in range(0,repetitions):
    ...
    for n in ns:
        ...
        CSV_PATH = f"./data_unique_run/csv/density_exp/{num_c}.csv"
        print(CSV_PATH)
        ...
        G, GT, labels = pd.custom_cluster_matrix(n, clusters, 0, 0, 0, 0)
        ...
        pu.plot_graphs([G, sze, fsze, musze], ["G", f"sze {k}", "fsze", "musze", f"n:{n} d:{density:.4f} num_c:{num_c}"], FILENAME=f"./data_unique_run/csv/density_exp/imgs/{num_c:03}_{n:05}.png", save=True, show=False)
